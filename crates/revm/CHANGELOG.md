...
## [21.1.0](https://github.com/Ayushdubey86/revm/compare/revm-v21.0.0...revm-v21.1.0) - 2025-04-05

### Added

- support for system calls ([#2350](https://github.com/Ayushdubey86/revm/pull/2350))
- Reorder revm deps in Cargo.toml ([#2331](https://github.com/Ayushdubey86/revm/pull/2331))
