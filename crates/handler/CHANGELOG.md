...
## [1.0.0-alpha.7](https://github.com/Ayushdubey86/revm/compare/revm-handler-v1.0.0-alpha.6...revm-handler-v1.0.0-alpha.7) - 2025-03-21

### Added

- Remove PrecompileError from PrecompileProvider ([#2233](https://github.com/Ayushdubey86/revm/pull/2233))
- allow reuse of API for calculating initial tx gas for tx ([#2215](https://github.com/Ayushdubey86/revm/pull/2215))

### Other

- remove wrong `&mut` and duplicated spec ([#2276](https://github.com/Ayushdubey86/revm/pull/2276))
- Add custom instruction example ([#2261](https://github.com/Ayushdubey86/revm/pull/2261))
