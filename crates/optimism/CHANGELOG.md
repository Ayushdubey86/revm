...
## [1.0.0-alpha.6](https://github.com/Ayushdubey86/revm/compare/op-revm-v1.0.0-alpha.5...op-revm-v1.0.0-alpha.6) - 2025-03-21
...
- *(op)* deposit txs are identifier 126 or 0x7e not 0x7f ([#2237](https://github.com/Ayushdubey86/revm/pull/2237))

### Other

- remove wrong `&mut` and duplicated spec ([#2276](https://github.com/Ayushdubey86/revm/pull/2276))
- *(op-precompiles)* clean up op tx tests ([#2242](https://github.com/Ayushdubey86/revm/pull/2242))
- make str to SpecId conversion fallible ([#2236](https://github.com/Ayushdubey86/revm/pull/2236))
- *(op-precompiles)* Add tests for bls12-381 map fp to g ([#2241](https://github.com/Ayushdubey86/revm/pull/2241))
- add a safe blst wrapper ([#2223](https://github.com/Ayushdubey86/revm/pull/2223))
- *(op-precompiles)* Reuse tests for bls12-381 msm tests for pairing ([#2239](https://github.com/Ayushdubey86/revm/pull/2239))
- *(op-precompiles)* add bls12-381 g2 add and msm tests ([#2231](https://github.com/Ayushdubey86/revm/pull/2231))
- *(op-precompiles)* Add test for g1 msm ([#2227](https://github.com/Ayushdubey86/revm/pull/2227))
- simplify single UT for OpSpecId compatibility. ([#2216](https://github.com/Ayushdubey86/revm/pull/2216))
- use AccessListItem associated type instead of AccessList ([#2214](https://github.com/Ayushdubey86/revm/pull/2214))
