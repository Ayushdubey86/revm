...
## [1.0.0-alpha.5](https://github.com/Ayushdubey86/revm/compare/op-revm-v1.0.0-alpha.4...op-revm-v1.0.0-alpha.5) - 2025-03-13

### Added

- add test for calling `bn128_pair` before and after granite ([#2200](https://github.com/Ayushdubey86/revm/pull/2200))

### Other

- *(op-test)* Clean up precompile tests ([#2206](https://github.com/Ayushdubey86/revm/pull/2206))
- fix typo in method name ([#2202](https://github.com/Ayushdubey86/revm/pull/2202))
- Add tests for checking fjord precompile activation ([#2199](https://github.com/Ayushdubey86/revm/pull/2199))
